...
const document = { activeElement: {}, getElementById: () => ({ children: [] }), createElement: () => ({}), body: { appendChild: () => {}, removeChild: () => {} }, addEventListener: () => {} };
const URL = { createObjectURL: () => {}, revokeObjectURL: () => {} };
const crypto = { subtle: { digest: async () => new Uint8Array(32) } };
